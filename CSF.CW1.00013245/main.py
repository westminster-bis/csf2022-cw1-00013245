...
#I created a menu, by usage of pygame library
from pygame import *
...
class Menu:#new created class
    ...
    def draw(self, surf, x, y, option_y_padding):
        for i, option in enumerate(self._options):
            ...
            option_rect.midleft = (x, y + i * option_y_padding)
...
menu = Menu()
menu.append_option('Start', quit_game)#quit game means to leave menu
...
#I added new background and song
background = pygame.image.load('sonic.jpg')#loadnig background image
mixer.music.load("song.mp3")#loading song
mixer.music.play()#loop song
...
def gameLoop():
    ...
    while not game_over:
        ...
        x1 += x1_change
        y1 += y1_change
        dis.blit(background,(0,0))# turning on new background
